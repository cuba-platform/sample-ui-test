...
public class UisampleTestContainer extends TestContainer {

    public UisampleTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/uisample/app.properties",
    ...
    public static class Common extends UisampleTestContainer {

        public static final UisampleTestContainer.Common INSTANCE = new UisampleTestContainer.Common();
